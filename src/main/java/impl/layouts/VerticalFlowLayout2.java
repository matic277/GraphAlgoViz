 ...
 * @since      March 24, 2001
 */
public class VerticalFlowLayout2 implements LayoutManager, java.io.Serializable {
     ...
     */
    public VerticalFlowLayout2(int halign, int valign) {
     ...
     */
    public VerticalFlowLayout2(int halign, int valign, int hgap, int vgap) {
        _hgap = hgap;
        _vgap = vgap;
